...
function SimpleDialog(props: SimpleDialogProps) {
  ...
  return (
    <Dialog onClose={handleClose} open={open} sx={{backgroundColor: 'transparent'}}>
      <div style={{display: 'flex', flexDirection: 'column', gap: '1rem', backgroundColor: '#006666', paddingLeft: '3rem', paddingRight: '3rem'}}>
          <h1 style={{display: 'flex', flexDirection: 'column', textAlign: 'center', color: 'rgba(240,247,247,1)'}}>
            Pesquisa Avançada
            <span style={{fontSize: '10px', textAlign: 'left', marginLeft: '3.5rem', display: 'flex', alignItems: 'center'}}>Powered by 
