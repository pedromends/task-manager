...
export default function TaskStep(){
    return (
        <main className="task-step">
            <div className="progress-card">
                <h1 style={{color: '#006666', textDecoration: 'underline', textDecorationColor: 'rgba(168,204,204,1)', textDecorationThickness: '3px'}}>Progresso</h1>
            ...
            <div className='cards-panel'>
                <h1 style={{color: '#006666', textAlign:'start', textDecoration: 'underline', textDecorationColor: 'rgba(168,204,204,1)', textDecorationThickness: '3px', margin: '0'}}>Painel de Passos</h1>
